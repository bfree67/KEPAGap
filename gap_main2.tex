...
\include{3_organization}
\include{4_gapresults}
\include{5_recommendations}
...
\begin{appendices}
\include{app_survey}
\include{app_funcanalysis}
\include{app_KEDDspillandwaste}
\include{app_SDG}
\include{app_Comments}
